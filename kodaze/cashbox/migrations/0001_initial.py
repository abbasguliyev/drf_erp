    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('office', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cashbox', to='company.office')),
            ],
            options={
                'ordering': ('pk',),
                'permissions': (('view_officecashbox', 'Mövcud ofise kassalara baxa bilər'), ('add_officecashbox', 'Ofis kassa əlavə edə bilər'), ('change_officecashbox', 'Ofis kassa məlumatlarını yeniləyə bilər'), ('delete_officecashbox', 'Ofis kassa silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('balance', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('holding', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cashbox', to='company.holding')),
            ],
            options={
                'ordering': ('pk',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('balance', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='cashbox', to='company.company')),
            ],
            options={
                'ordering': ('pk',),
