...
class Service(models.Model):
    ...
    total_paid_amount = models.DecimalField(default=0, max_digits=20, decimal_places=2)
    remaining_payment = models.DecimalField(default=0, max_digits=20, decimal_places=2)
...
class ServicePayment(models.Model):
    ...
    create_date = models.DateField(auto_now_add=True)
    service_amount = models.DecimalField(default=0, max_digits=20, decimal_places=2)
    is_done = models.BooleanField(default=False)
