...
from restAPI.company.serializers import OfisSerializer, ShirketSerializer, ShobeSerializer

from restAPI.account.serializers import MusteriSerializer, UserSerializer
from restAPI.product.serializers import MehsullarSerializer
