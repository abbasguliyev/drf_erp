    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('muqavile_tarixi', models.DateField(blank=True, null=True)),
                ...
                ('odenis_uslubu', models.CharField(choices=[('NƏĞD', 'NƏĞD'), ('KREDİT', 'KREDİT')], default='NƏĞD', max_length=20)),
                ...
                ('borc_baglanma_tarixi', models.DateField(blank=True, null=True)),
                ...
                ('group_leader', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='group_leader', to=settings.AUTH_USER_MODEL)),
                ...
                ('menecer1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='menecer1', to=settings.AUTH_USER_MODEL)),
                ('menecer2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='menecer2', to=settings.AUTH_USER_MODEL)),
            ...
            options={
                'ordering': ('-pk',),
                'permissions': (('view_muqavile', 'Mövcud müqavilələrə baxa bilər'), ('add_muqavile', 'Müqavilə əlavə edə bilər'), ('change_muqavile', 'Müqavilə məlumatlarını yeniləyə bilər'), ('delete_muqavile', 'Müqavilə silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'ordering': ('pk',),
                'permissions': (('view_odemetarix', 'Mövcud ödəmələrə baxa bilər'), ('add_odemetarix', 'Ödəmə əlavə edə bilər'), ('change_odemetarix', 'Ödəmə məlumatlarını yeniləyə bilər'), ('delete_odemetarix', 'Ödəmə silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'ordering': ('-pk',),
                'permissions': (('view_muqavilekreditor', 'Mövcud kreditorlara baxa bilər'), ('add_muqavilekreditor', 'Müqavilə Kreditor əlavə edə bilər'), ('change_muqavilekreditor', 'Müqavilə Kreditor məlumatlarını yeniləyə bilər'), ('delete_muqavilekreditor', 'Müqavilə Kreditor silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'ordering': ('pk',),
                'permissions': (('view_muqavilehediyye', 'Mövcud müqavilə hədiyyələrə baxa bilər'), ('add_muqavilehediyye', 'Müqavilə hədiyyə əlavə edə bilər'), ('change_muqavilehediyye', 'Müqavilə hədiyyə məlumatlarını yeniləyə bilər'), ('delete_muqavilehediyye', 'Müqavilə hədiyyə silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'ordering': ('-pk',),
                'permissions': (('view_deyisim', 'Mövcud dəyişimlərə baxa bilər'), ('add_deyisim', 'Dəyişim əlavə edə bilər'), ('change_deyisim', 'Dəyişim məlumatlarını yeniləyə bilər'), ('delete_deyisim', 'Dəyişim silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'ordering': ('-pk',),
                'permissions': (('view_demosatis', 'Mövcud demo satışlara baxa bilər'), ('add_demosatis', 'Demo satış əlavə edə bilər'), ('change_demosatis', 'Demo satış məlumatlarını yeniləyə bilər'), ('delete_demosatis', 'Demo satış silə bilər')),
                'default_permissions': [],
            },
        ),
    ]
