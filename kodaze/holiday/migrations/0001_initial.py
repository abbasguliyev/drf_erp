    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holidays', models.CharField(blank=True, max_length=500, null=True)),
                ('date', models.DateField(blank=True, default=datetime.datetime.now)),
                ('section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='working_days', to='company.section')),
            ],
            options={
                'ordering': ('pk',),
                'permissions': (('view_sectionworkingday', 'Mövcud şöbə tətil günlərinə baxa bilər'), ('add_sectionworkingday', 'Şöbə tətil günü əlavə edə bilər'), ('change_sectionworkingday', 'Şöbənin tətil günü məlumatlarını yeniləyə bilər'), ('delete_sectionworkingday', 'Şöbənin tətil gününü silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holidays', models.CharField(blank=True, max_length=500, null=True)),
                ('exception_workers', models.ManyToManyField(blank=True, to=settings.AUTH_USER_MODEL)),
                ('working_day', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='exception_worker', to='holiday.sectionworkingday')),
            ],
            options={
                'ordering': ('pk',),
                'permissions': (('view_sectionexceptionworker', 'Mövcud şöbə istisna işçilərə baxa bilər'), ('add_sectionexceptionworker', 'Şöbə istisna işçi əlavə edə bilər'), ('change_sectionexceptionworker', 'Şöbə istisna işçi məlumatlarını yeniləyə bilər'), ('delete_sectionexceptionworker', 'Şöbə istisna işçiməlumatalrını silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('pk',),
                'permissions': (('view_officeexceptionworker', 'Mövcud office istisna işçilərə baxa bilər'), ('add_officeexceptionworker', 'Office istisna işçi əlavə edə bilər'), ('change_officeexceptionworker', 'Office istisna işçi məlumatlarını yeniləyə bilər'), ('delete_officeexceptionworker', 'Office istisna işçiməlumatalrını silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
