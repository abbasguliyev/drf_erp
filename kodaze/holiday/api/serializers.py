...
from company.api.serializers import HoldingSerializer, TeamSerializer, OfficeSerializer, CompanySerializer, SectionSerializer, PositionSerializer
...
class HoldingExceptionWorkerSerializer(DynamicFieldsCategorySerializer):
    ...
    exception_workers_id = serializers.PrimaryKeyRelatedField(
        queryset=user_list(), source='exception_workers', write_only=True, many=True
    )
