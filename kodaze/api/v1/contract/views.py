...
from api.v1.contract.serializers import (
    DemoSalesSerializer,
...
from api.v1.contract.utils import (
    installment_utils,
    contract_utils,
    contract_gift_utils,
)
...
from api.v1.contract.filters import (
    DemoSalesFilter,
    ContractGiftFilter,
    InstallmentFilter,
    ContractFilter,
...
from api.v1.contract.services import contract_service, installment_service, contract_change_service
