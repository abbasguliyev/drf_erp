...
def advancepayment_create(
    ...
    user_advanced_payment = AdvancePayment.objects.filter(employee=employee, salary_date__year=f"{salary_date.year}", salary_date__month=f"{salary_date.month}").count()
