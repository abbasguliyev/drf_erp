...
class AbstractCashboxOperation(models.Model):
    ...
    cost_type = models.ForeignKey('cashbox.CostType', on_delete=models.SET_NULL, null=True, blank=True)
...
class CostType(models.Model):
    ...
    class Meta:
        ...
        default_permissions = []
        permissions = (
            ("view_costtype", "Mövcud xərc növlərinə baxa bilər"),
            ("add_costtype", "Xərc növü əlavə edə bilər"),
            ("change_costtype", "Xərc növü məlumatlarını yeniləyə bilər"),
            ("delete_costtype", "Xərc növü məlumatlarını silə bilər")
        )
...
class CashFlow(models.Model):
    ...
    quantity = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    cost_type = models.ForeignKey('cashbox.CostType', related_name="cash_flows", on_delete=models.SET_NULL, null=True, blank=True)
