    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf', models.FileField(blank=True, null=True, upload_to='media/media/contract_doc/%Y/%m/%d/', validators=[core.image_validator.file_size, django.core.validators.FileExtensionValidator(['pdf'])])),
                ('pdf2', models.FileField(blank=True, null=True, upload_to='media/media/contract_doc/%Y/%m/%d/', validators=[core.image_validator.file_size, django.core.validators.FileExtensionValidator(['pdf'])])),
                ...
                ('intervention_product_status', models.CharField(blank=True, choices=[('DƏYİŞİLMİŞ MƏHSUL', 'DƏYİŞİLMİŞ MƏHSUL')], default=None, max_length=50, null=True)),
                ...
                ('manager1', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='manager1', to=settings.AUTH_USER_MODEL)),
                ('manager2', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='manager2', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conditional_payment_status', models.CharField(blank=True, choices=[('BURAXILMIŞ AY', 'BURAXILMIŞ AY'), ('NATAMAM AY', 'NATAMAM AY'), ('RAZILAŞDIRILMIŞ AZ ÖDƏMƏ', 'RAZILAŞDIRILMIŞ AZ ÖDƏMƏ'), ('ARTIQ ÖDƏMƏ', 'ARTIQ ÖDƏMƏ'), ('SON AYIN BÖLÜNMƏSİ', 'SON AYIN BÖLÜNMƏSİ')], default=None, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'ordering': ('-pk',),
                'permissions': (('view_contractcreditor', 'Mövcud installmentorlara baxa bilər'), ('add_contractcreditor', 'Müqavilə Creditor əlavə edə bilər'), ('change_contractcreditor', 'Müqavilə Creditor məlumatlarını yeniləyə bilər'), ('delete_contractcreditor', 'Müqavilə Creditor silə bilər')),
                'default_permissions': [],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='changed_contracts', to='product.product')),
            ],
            options={
                'ordering': ('-pk',),
