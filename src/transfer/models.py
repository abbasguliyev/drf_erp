...
class AbstractTransfer(models.Model):
    ...
    transfer_amount = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    transfer_date = models.DateField(auto_now=True)
    transfer_note = models.TextField(null=True, blank=True)
    recipient_subsequent_balance = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    sender_subsequent_balance = models.DecimalField(default=0, max_digits=20, decimal_places=0)
