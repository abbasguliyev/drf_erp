...
class EmployeeWorkingDaySerializer(DynamicFieldsCategorySerializer):
    ...
    def get_extra_data(self, instance):
        ...
        qs['total_holiday'] = int(total_holiday)
        qs['total_payed_days_off'] = int(total_payed_days_off)
        qs['total_unpayed_days_off'] = int(total_unpayed_days_off)
...
class HolidayOperationSerializer(DynamicFieldsCategorySerializer):
    ...
    office_id = serializers.PrimaryKeyRelatedField(
        queryset=office_list(), source='office', allow_null=True, write_only=True
    )
