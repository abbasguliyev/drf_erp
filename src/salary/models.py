...
class Commission(models.Model):
    ...
    for_office = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    cash = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    for_team = models.DecimalField(default=0, max_digits=20, decimal_places=0)
...
class SalaryView(AbstractSalaryMethod):
    ...
    sales_amount = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    final_salary = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    date = models.DateField(null=True, blank=True)
    is_done = models.BooleanField(default=False)
    pay_date = models.DateField(null=True, blank=True)
    commission_amount = models.DecimalField(default=0, max_digits=20, decimal_places=0)
...
class EmployeeActivityHistory(models.Model):
    ...
    bonus = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    advance_payment = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    salary_deduction = models.DecimalField(default=0, max_digits=20, decimal_places=0)
    salary_punishment = models.DecimalField(default=0, max_digits=20, decimal_places=0)
