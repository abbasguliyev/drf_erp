...
@receiver(post_save, sender=User)
def create_employee_activity(sender, instance, created, **kwargs):
    if created:
        instance_id = instance.id
        is_active = instance.is_active
        transaction.on_commit(lambda: create_employee_activity_task.delay(instance_id, is_active))
