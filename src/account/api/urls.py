...
urlpatterns = [
    ...
    path('me/', account_views.CurrentUser.as_view()),
    ...
    path('customers/', account_views.CustomerListAPIView.as_view()),
    path('create-customer/', account_views.CustomerCreateAPIView.as_view()),
    ...
    path('employee-contract-history/', account_views.EmployeeActivityListAPIView.as_view()),
]