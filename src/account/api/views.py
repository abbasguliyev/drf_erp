...
from account.api.services import all_region_create, create_customer, create_employee_status, create_user, update_user, delete_user, region_create
from account.api.selectors import user_list, customer_list, employee_status_list, region_list, employee_activity_list
...
class CustomerCreateAPIView(APIView):
    ...
    def post(self, request):
        ...
        return Response({'detail': 'Müştəri əlavə edildi', 'id':f'{customer.id}'}, status=status.HTTP_201_CREATED)
...
class EmployeeActivityListAPIView(generics.ListAPIView):
    queryset = employee_activity_list()
