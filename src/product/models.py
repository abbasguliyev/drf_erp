...
class Product(models.Model):
    ...
    purchase_price = models.DecimalField(default=0, max_digits=23, decimal_places=0, null=True, blank=True)
    ...
    weight = models.DecimalField(max_digits=23, decimal_places=0, null=True, blank=True)
    width = models.DecimalField(max_digits=23, decimal_places=0, null=True, blank=True)
    length = models.DecimalField(max_digits=23, decimal_places=0, null=True, blank=True)
    height = models.DecimalField(max_digits=23, decimal_places=0, null=True, blank=True)
    volume = models.DecimalField(max_digits=23, decimal_places=0, null=True, blank=True)
