...
class HoldingWarehouse(models.Model):
    ...
    class Meta:
        ...
        permissions = (
            ...
            ("add_holdingwarehouse", "Holding anbar əlavə edə bilər"),
            ("change_holdingwarehouse", "Holding anbar məlumatlarını yeniləyə bilər"),
            ("delete_holdingwarehouse", "Holding anbar silə bilər")
        )
